...
import { getTourBySlug, tourPackages } from "@/lib/data/tours";
  ...
  return (
    <>
      <section className="relative overflow-hidden bg-primary-dark text-white">
        <PlaceholderImage label={tour.destinationLabel} fill className="opacity-30" />
      ...
      <Section className="pb-0">
        <QuickInfoCards items={tour.quickInfo} />
      </Section>
